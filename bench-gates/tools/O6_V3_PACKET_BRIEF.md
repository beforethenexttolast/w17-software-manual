...
| **S4 output-driven term** | 6 | S4's driven bound already stands without item 6 (**≥ 640 mA** at the MAX98357A's own 3.2 W / 4 Ω / 5 V condition, energy conservation, `first_power_current_limits.md` L13). **What item 6 changes:** if the speaker proves 8 Ω rather than the BOM's stated 4 Ω, every S4 figure derived at 4 Ω becomes slack, never tighter (P ∝ V²/Z, `BG-03`:150). Feed the confirmed impedance into the amp rows (S4, T7, L13) as a labelled correction, not a replacement of the 640 mA floor. |
