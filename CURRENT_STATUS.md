...
Merge note: the unmerged mapper branch (`docs/mapper-config-entry`) also carries 2026-08-04
entries in this file's header; whichever branch merges second stacks its entry above/below
the other's — the overlap is this header block only, both edits are append-shaped.
...
- **A2 adversarial review 2026-08-03 — found A2 unsafe to execute as written; the owed
  revision pass is DONE 2026-08-04, pending owner review/merge.** The review (14 findings,
