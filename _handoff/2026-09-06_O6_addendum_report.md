...
| **N4** | non-blk | `BG-03`:126 for *"≥ 640 mA whenever driven"* | **`BG-03`:150** (verified at r3 `0429b3d`); the S5 row is **`BG-03`:151**; the siblings are **`first_power_current_limits.md`:76** (L13) and **:106** (T11). An applier following `:126` lands in the inrush paragraph |
