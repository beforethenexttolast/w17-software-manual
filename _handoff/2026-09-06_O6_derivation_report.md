...
| UBEC A / UBEC B (rail sources) | **"UBEC 5 A (2 pcs)"** / BOM `UBEC 5 A  2PCS 5A`. No brand, no model. Type is doc-stated as **switching** (*"two switching UBEC outputs hard-paralleled"*) | `HARDWARE_INVENTORY.md`:113 ; `w17-control-fw/docs/bill_of_materials_v2.md`:77 ; `w17-control-fw/project-review/13_phase_a_a2_no_power_checklist.md`:238 | **none found — no model to look up.** This is why η in §3.1's pack-side form is unknown |
