> **Transfer snapshot — NON-CANONICAL.** This is the r3 successor handoff (written 2026-09-06 late evening by session 719f19ec on `program/offline-readiness-r3` 86da42c),
> preserved verbatim when it was superseded on 2026-09-06 night after the DR3 grant landed r3 on workspace main (20acc8f). **Canonical source now:** `NEW_SESSION_HANDOFF.md`
> on workspace branch `program/offline-readiness-r4` (r4). Its §0–§2 describe trunks and a grant that have since landed/been consumed; where it and the r4 handoff or
